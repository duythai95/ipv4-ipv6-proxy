...
install_3proxy() {
    ...
    wget https://raw.githubusercontent.com/duythai95/ipv4-ipv6-proxy/master/scripts/3proxy.service-Centos8 --output-document=/3proxy/3proxy-0.9.3/scripts/3proxy.service2
